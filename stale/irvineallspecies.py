...
ddir = _ddir + "Irvine/"
csv_file = ddir+'IrvineAllSpecies.csv'

# shortening from IrvineDogs
sampleStart = pd.to_datetime('2016-07-01').date()
sampleEnd = pd.to_datetime('2024-01-01').date()
...
csv_columns = [
    ...
    'impound_no','outcome_cond','animal_type' ]
